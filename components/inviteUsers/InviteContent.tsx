...
export const InviteContent = ({
    ...
    const inviteURL = useMemo(() => {
        ...
        return `${domain}/${lang}/dashboard/invite/${codes.inviteCode
    ...
    return (
        <div className="space-y-4 my-6">
                    ...
                    >
                        ...
                        >
                            <div className="flex flex-col gap-1">
                                ...
                                <p className="text-muted-foreground text-xs sm:text-sm gap-1">
                                    {t("VIEWER.DESC")}
                                </p>
                            </div>
                        </DropdownMenuItem>
            ...
            <Button
                disabled={isPending}
                onClick={copyHandler}
                className="w-full text-white dark:text-black font-bold flex items-center gap-2"
            >
                <Copy size={18} />
                {t("COPY")}
            </Button>
