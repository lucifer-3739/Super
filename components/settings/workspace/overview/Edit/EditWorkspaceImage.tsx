        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <div className="flex flex-col space-y-1.5 justify-start">
                ...
                <DialogTrigger asChild>
                    <Button
                        className={cn(
                            `w-16 h-16 text-white dark:text-black font-bold ${!image && workspaceColor}`
                        )}
            ...
            <DialogContent className="sm:max-w-[28rem] flex flex-col justify-center items-center p-8">
                ...
                <div
                    className={`w-32 h-32 sm:w-40 sm:h-40 text-4xl text-white dark:text-black font-bold rounded-lg flex justify-center items-center my-5 ${!imagePreview && !image && workspaceColor
                        } pointer-events-none`}
                >
                    {imagePreview ? (
                        <Image
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                        ...
                        <div className="mt-5 w-full flex justify-center items-center gap-4">
                            ...
                            <Button
                                type="submit"
                                className={`rounded-full w-12 h-12 p-2 ${imageOptions.canSave ? "text-white dark:text-black" : "text-muted-foreground"
                                    }`}
