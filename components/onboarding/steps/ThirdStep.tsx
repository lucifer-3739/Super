...
export const ThirdStep = () => {
    ...
    return (
        <>
            <div className="flex flex-col justify-center items-center gap-4 w-full my-8 text-center">
            ...
            <Form {...form}>
                <form
                    ...
                    className="w-full max-w-md md:space-y-4 lg:space-y-6 sm:space-y-2 mt-6"
                >
                    ...
                    <Button
                        ...
                        type="submit"
                        className="w-full mt-10 max-w-md dark:text-black font-semibold"
                    >
                        {isUploading ? (
                            <LoadingState />
                        ) : (
