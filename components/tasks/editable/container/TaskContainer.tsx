...
import { TaskCalendar } from "@/components/tasks/editable/container/TaaskCalendar";
...
export const TaskContainer = ({
    ...
    const debouncedCurrentActiveTags = useDebouncedCallback(() => {
        onSetStatus("pending");
        const tagsIds = currentActiveTags.map((tag: { id: any; }) => tag.id);
                    ...
                    <div className="w-full flex flex-col sm:flex-row items-start gap-2 sm:gap-4">
                        ...
                        <div className="w-full flex flex-col gap-2">
                            ...
                            <div className="w-full gap-1 flex flex-wrap flex-row">
                                ...
                                />
                                {currentActiveTags.map((tag: { name: string; id: string; color: $Enums.CustomColors; workspaceId: string; }) => (
