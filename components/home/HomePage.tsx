    ...
    <>
      ...
      <div className="w-full mx-auto max-w-screen-xl px-4 sm:px-6">
        ...
        <main>
          ...
          <div
            ref={$follower}
            className="pointer-events-none fixed left-0 top-0 h-6 w-6 -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-bl from-red-700 to-red-400 opacity-80 shadow-lg"
          ></div>
          <Section
            id="Mind-Maps"
